...
public class WebSecurityConfig {
    ...
    /**
     * Configures the DaoAuthenticationProvider which is responsible for fetching user details
     ...
     * This defines which endpoints are public and which are protected.
     */
    @Bean
